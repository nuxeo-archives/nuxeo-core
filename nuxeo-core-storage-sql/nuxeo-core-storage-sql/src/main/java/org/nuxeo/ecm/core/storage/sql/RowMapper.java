...
public interface RowMapper {
     ...
     *
     */
    void insertSimpleRows(String tableName, List<Row> singletonList) throws StorageException;
     ...
     */
    void deleteSimpleRows(String tableName, Set<Serializable> singleton) throws StorageException;
    ...
    public static final class IdWithTypes implements Serializable {
        ...
        public IdWithTypes(Node node) {
            id = node.getId();
            primaryType = node.getPrimaryType();
            mixinTypes = node.getMixinTypes();
        }
        ...
        public IdWithTypes(SimpleFragment hierFragment) throws StorageException {
            ...
            mixinTypes = (String[]) hierFragment.get(Model.MAIN_MIXIN_TYPES_KEY);
        }
    ...
    public static final class CopyResult implements Serializable {
        ...
        public final InvalidationsRows invalidations;

        /** The ids of newly created proxies. */
        public final Set<Serializable> proxyIds;

        public CopyResult(Serializable copyId, InvalidationsRows invalidations,
