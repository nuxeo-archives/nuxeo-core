...
public class TestSQLRepositoryProperties extends SQLRepositoryTestCase {
    ...
    // External Blobs not implemented in 5.1.6 version
    public void xxtestExternalBlobDocumentProperty() throws Exception {
        File file = createTempFile();
        HashMap<String, String> map = new HashMap<String, String>();
        String uri = String.format("fs:%s", file.getName());
        map.put("uri", uri);
        map.put("name", "hello.txt");
    ...
    // External Blobs not implemented in 5.1.6 version
    public void xxtestExternalBlobDocumentProperty2() throws Exception {
        File file = createTempFile();
        String uri = String.format("fs:%s", file.getName());
    ...
    // NXP-2468
    // External Blobs not implemented in 5.1.6 version
    public void xxtestExternalBlobListValue() throws Exception {
        // not null on list
    ...
    // NXP-2301
    // External Blobs not implemented in 5.1.6 version
    public void xxtestSubExternalBlobValue() throws Exception {
